...
const WriteEdit = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await Api(`posts/${postId}`, data, 'patch', user, dispatch, Navigate);
        if (res.status != 200) {
            toast.error(res.statusText)
        } else {
            toast.success("Your Article has been changed");
        ...
        <>
            {!loaded ? (
                ...
                <>
                    ...
                    px-4 rounded focus:outline-none focus:shadow-outline" type="submit">Update Article</button>
                                </div>
