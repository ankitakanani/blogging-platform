...
px-4 rounded focus:outline-none focus:shadow-outline">
                ...
                >
                  ...
                  <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:pb-0 xl:col-span-3 xl:row-span-2">
                    ...
                    {postData.comment_count > 0 && commentShow &&
                      <CommentBody postId={postData.id} />
                    }
          ...
          <Modal isOpen={deleteModal} setIsOpen={setDeleteModal} title="Delete the Article"
            body="Are you sure you want to delete your Article?" handleDelete={handleDelete} setLoaded={setLoadedarticle} />
          <ModalForm edit={false} isOpen={commentModal} setIsOpen={setCommentModal} selectedPost={selectedPost}  setLoaded={setLoaded} />
